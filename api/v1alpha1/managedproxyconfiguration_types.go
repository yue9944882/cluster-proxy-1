...
type ManagedProxyConfigurationAuthentication struct {
	...
	// +optional
	AgentAuth ManagedProxyConfigurationAuthenticationAgentAuth `json:"agentAuth"`
}

type ManagedProxyConfigurationAuthenticationAgentAuth struct {
	// +optional
	// +kubebuilder:default=open-cluster-management-cluster-proxy
	ServiceAccountNamespace string `json:"serviceAccountNamespace"`
	// +optional
	// +kubebuilder:default=proxy-agent-authentication
	ServiceAccountName string `json:"serviceAccountName"`
	// +optional
	// +kubebuilder:default=cluster-proxy
	ServiceAccountAudience string `json:"serviceAccountAudience"`
}
...
type AuthenticationSelfSigned struct {
	// +optional
	Rotation CertificateSigningRotation `json:"rotation"`
	// +optional
...
const (
	ConditionTypeAllSecretGenerated  = "AllSecretGenerated"
